...
sudo scutil --set ComputerName "AMBP"
sudo scutil --set HostName "AMBP"
sudo scutil --set LocalHostName "AMBP"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "AMBP"
...
# NOTE: https://github.com/mathiasbynens/dotfiles/commit/13e29f408fc360360b4468aef2c318dff287c7d2#r38281009
